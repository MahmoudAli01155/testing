...
describe("testing App component", () => {
  ...
  test("should show No Error when every thing is valid", () => {
    typeIntoFormElements({
      email: "afgdf@asdas.com",
      password: "Xasda",
      confirmPassword: "Xasda",
    });
    ...
    expect(
      screen.queryByText(/The password you entered should contain 7 or more characters./i)
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText(/First alphabet must be Capital./i)
    ).not.toBeInTheDocument();
    expect(
